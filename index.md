...
<p>This task builds on tasks 1.1 and 1.3 to do a manual close evaluation of how LLMs fare when provided with guidance. We ran this evaluation over only 3 deep source documents to make sure we could provide accurate transcriptions as part of the guidance. In 1.1 we established how a scholar would analyze a deep source. In task 1.3, we evaluated how a range of LLMs responded to a set of questions about the deep source documents. In task 1.4, we asked those same questions, but provided, in step 1, context (background information about the materials) as guidance. In a step 2 evaluation, we also provided the transcriptions.<a href="/propel-1.4/">Read the task report.</a></p>
</section>
